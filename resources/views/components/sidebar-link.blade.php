...
<a x-data="{ tipTop: 0, tipLeft: 0 }"
    @mouseenter="let rect = $el.getBoundingClientRect(); tipTop = rect.top + (rect.height/2); tipLeft = rect.right + 10"
    {{ $attributes->merge(['class' => 'group relative flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all ' . $classes]) }} wire:navigate>
    <div class="shrink-0 w-6 h-6">
        ...
        @elseif($icon == 'ethernet')
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-ethernet-port-icon lucide-ethernet-port">
        ...
        @elseif($icon == 'piutang')
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-mail-minus-icon lucide-mail-minus">
