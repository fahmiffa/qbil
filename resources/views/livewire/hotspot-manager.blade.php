            ...
            <div class="p-4 sm:p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-4 mb-4">
                    ...
                    <div class="grid grid-cols-2 lg:flex w-full lg:w-auto gap-3">
                        ...
                        <div class="col-span-1">
                            <label class="block text-xs font-medium text-gray-700 dark:text-slate-300 mb-1">Tanggal (Generate):</label>
                            <input type="date" wire:model.live="filterDate" class="w-full border border-gray-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 rounded-lg px-3 py-2 text-xs focus:outline-none focus:ring-2 focus:ring-blue-500">
                        </div>
                        <div class="col-span-1">
                            ...
                            <form wire:submit.prevent="store">
                                ...
                                <div class="bg-gray-50 dark:bg-slate-900/50 px-4 py-3 sm:px-6 flex flex-row-reverse gap-2">
                                    <button type="submit" wire:loading.attr="disabled" wire:target="store"
                                        ...
                                        <svg wire:loading wire:target="store" class="animate-spin h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <table class="min-w-full min-w-[850px] divide-y divide-gray-200 dark:divide-slate-700">
                        <thead class="bg-gray-50 dark:bg-slate-900/50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-slate-400 uppercase tracking-wider whitespace-nowrap">Tanggal Generate</th>
                        ...
                        <tbody class="bg-white dark:bg-slate-800 divide-y divide-gray-200 dark:divide-slate-700 transition-colors">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                    <div class="text-xs font-medium text-gray-500 dark:text-slate-400">{{ $hu->created_at ? $hu->created_at->format('d M Y, H:i') : '-' }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-center">
                                    @if($hu->is_printed)
                            ...
                            @empty
                            <tr>
                                <td colspan="8" class="px-6 py-10 text-center text-gray-500 dark:text-slate-500 italic">Belum ada data user hotspot.</td>
                            </tr>
                            @endforelse
