                            ...
                            <form wire:submit.prevent="save" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div class="relative group">
                                        <input type="{{ $showPassword ? 'text' : 'password' }}" class="w-full border border-gray-300 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 rounded-lg pl-3 pr-11 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors font-mono" wire:model="password" placeholder="Password API Mikrotik">
                                        <button type="button" wire:click="togglePassword" class="absolute inset-y-0 right-0 flex items-center px-3.5 text-slate-400 hover:text-blue-500 transition-colors">
                                            @if($showPassword)
